...
const Students = () => {
  ...
  const columns: GridColDef[] = [
    { 
      ...
      renderCell: (params) => (
        <Avatar 
          src={params.value?.startsWith('http') ? params.value : `http://localhost:8082${params.value}`} 
        ...
        <Box>
          <IconButton
            ...
            onClick={() => {
              ...
              setPreviewUrl(params.row.profilePhoto?.startsWith('http') ? params.row.profilePhoto : `http://localhost:8082${params.row.profilePhoto}`);
              setOpen(true);
            }}
